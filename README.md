...
- 📄 Places I've written cool stuff
  ...
  3.   DevOps & CI/CD - https://earthly.dev/blog/ci-vs-cd/
  4.   Frontend web apps & performance - https://blog.logrocket.com/comlink-web-workers-match-made-in-heaven/
  5.   TS / JS tips tricks [Enforcing Correctness Across Dependent Function Argument Values At Compile Time](https://chalu.hashnode.dev/using-generics-in-typescript-to-ensure-symmetry-in-function-argument-values)
...
- ⚡ Watch out: I mentor engineers and programs across Africa, through programs like [TalentQL](https://pipeline.talentql.com/).
- ⚡ I am a published author. Back in 2012, I published [a Java title](https://www.packtpub.com/product/extgwt-rich-internet-application-cookbook/9781849515184) and might be working on something for backend, cloud and distributted systems in the near future
